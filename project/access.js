...
app.set('views', path.join(_dirname,'pages'));
app.set('view engine', 'ejs');

app.get('/',function (req,res){
	res.sendFile(path.join(_dirname, 'log.html'));
});
...
app.get('/admin',function(req, res){
	...
	if (req.session.username == 'admin'){
		console.log(req.session.username+'requested page');
...
app.get('/guest',function(req, res){
	//старница без ограничения доступа
